...
error_reporting(0);
    $query = "select * from room where availability='YES' ORDER BY room_number";
      ...
      <tr><td><?php echo $x; ?></td>
        ...
        <td><?php echo $row['category_name'] ?></td>
         ...
         <td><img src="<?php echo $imgpath;?>" alt="HTML5 Icon" style="width:128px;height:128px"></td>
          <td><a style="text-decoration:none" href="edit_room.php?id=<?php echo $row['room_id'] ?>">Edit </a> |
            <a style="text-decoration:none" href="javascript:void(0);" onclick="chk('<?php echo $row['room_id'] ?>')">Delete</a>
...
?>
<br>
 <a href="add_room.php" class="link">Add Room</a>
...
function chk(val){
 ...
 if(result){
   location.href="delete_room.php?id="+val;
 }
}
</script>
</body>
